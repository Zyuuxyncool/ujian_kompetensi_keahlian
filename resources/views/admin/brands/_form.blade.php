<form id="form_info">
    ...
    <div class="modal-header">
        <div class="card-title fs-3 fw-bold">{{ !empty($brand) ? 'Ubah' : 'Tambah' }} Cetegory</div>
    </div>
    <div class="modal-body">
        <div class="row">
            <div class="col-lg-10">
                <x-metronic-input name="name" caption="Nama" :value="$brand->name ?? ''" />
            </div>
            <div class="col-lg-2">
                ...
                <img src="{{ ($brand->photo ?? '') != '' ? Storage::url($brand->photo) : asset('images/default.jpg') }}" id="preview_foto" alt="" class="w-100 h-auto object-fit-cover shadow-xs rounded-1" />
