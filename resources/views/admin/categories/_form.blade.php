<form id="form_info">
    ...
    <div class="modal-header">
        <div class="card-title fs-3 fw-bold">{{ !empty($category) ? 'Ubah' : 'Tambah' }} Cetegory</div>
    </div>
    <div class="modal-body">
        <div class="row">
            <div class="col-lg-10">
                <x-metronic-input name="name" caption="Nama" :value="$category->name ?? ''" />
            </div>
            <div class="col-lg-2">
                ...
                <div class="d-none"><x-input type="file" name="file_photo" alert="0" /><x-inputname="delete_foto" alert="0" /></div>
                <img src="{{ ($category->photo ?? '') != '' ? Storage::url($category->photo) : asset('images/default.jpg') }}" id="preview_foto" alt="" class="w-100 h-auto object-fit-cover shadow-xs rounded-1" />
